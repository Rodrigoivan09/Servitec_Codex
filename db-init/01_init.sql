-- MariaDB initialization script for first-time container start
-- Note: The database is created by MYSQL_DATABASE in docker-compose.

-- Schema and seed data (derived from Flyway V1__init.sql)
...
-- Técnico demo por username 'tecnico' (para ambientes nuevos)
